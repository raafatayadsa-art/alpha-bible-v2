/*
  RUN IN SUPABASE SQL EDITOR — enable Alpha Connect automatic deletion
  Timed purge (pg_cron) + on_read consume trigger + expires_at backfill
*/
...
select public.alpha_connect_purge_expired_messages() as purged_now;
