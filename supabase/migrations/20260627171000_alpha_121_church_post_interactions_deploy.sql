-- DOMAIN-03 Church Community — post comments & reactions (ALPHA-121 P2)
...
comment on table public.church_post_comments is 'DOMAIN-03 Church Community: post comments';
comment on table public.church_post_reactions is 'DOMAIN-03 Church Community: post reactions';
