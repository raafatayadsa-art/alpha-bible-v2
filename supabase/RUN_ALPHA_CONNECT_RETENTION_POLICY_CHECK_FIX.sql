/*
  RUN IN SUPABASE SQL EDITOR — fixes 23514 alpha_connect_messages_retention_policy_check
  Applies the same fix as migration 20250617200000_alpha_connect_retention_policy_check_fix.sql
*/
...
where nsp.nspname = 'public'
  and rel.relname = 'alpha_connect_messages'
  and con.conname = 'alpha_connect_messages_retention_policy_check';
