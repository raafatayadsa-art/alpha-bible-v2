...
export const BOOK_SYMBOL_REGISTRY: Record<BibleBookId, BookSymbolDef> = {
  ...
  Esther: { symbol: "scepter", color: "#a8548a", colorLight: "#d080b0", categoryAr: "تاريخ", order: 17 },
  Job: { symbol: "ashes", color: "#5a5a6a", colorLight: "#888898", categoryAr: "حكمة", order: 18 },
  Psalms: { symbol: "harp", color: "#d4af37", colorLight: "#e8cc70", categoryAr: "مزامير", order: 19 },
  Proverbs: { symbol: "lamp", color: "#b8893a", colorLight: "#d8b068", categoryAr: "حكمة", order: 20 },
  Ecclesiastes: { symbol: "sun", color: "#8a7355", colorLight: "#b8a080", categoryAr: "حكمة", order: 21 },
  SongOfSolomon: { symbol: "rose", color: "#c44569", colorLight: "#e07090", categoryAr: "حكمة", order: 22 },
  Isaiah: { symbol: "wing", color: "#3d5a9a", colorLight: "#6a88c4", categoryAr: "نبوة", order: 23 },
  Jeremiah: { symbol: "vessel", color: "#6a4a5a", colorLight: "#987888", categoryAr: "نبوة", order: 24 },
  Lamentations: { symbol: "tears", color: "#4a5a7a", colorLight: "#7888a8", categoryAr: "نبوة", order: 25 },
  Ezekiel: { symbol: "wheel", color: "#5a6a9a", colorLight: "#8898c8", categoryAr: "نبوة", order: 26 },
  Daniel: { symbol: "lionDen", color: "#b8893a", colorLight: "#d8b068", categoryAr: "نبوة", order: 27 },
  Hosea: { symbol: "covenant", color: "#a85450", colorLight: "#d08078", categoryAr: "نبوة", order: 28 },
  Joel: { symbol: "locust", color: "#4a7a5a", colorLight: "#78a888", categoryAr: "نبوة", order: 29 },
  Amos: { symbol: "plumb", color: "#6a5a32", colorLight: "#988860", categoryAr: "نبوة", order: 30 },
  Obadiah: { symbol: "mountain", color: "#5a7a8a", colorLight: "#88a8b8", categoryAr: "نبوة", order: 31 },
  Jonah: { symbol: "fish", color: "#3d6a8a", colorLight: "#6a98b8", categoryAr: "نبوة", order: 32 },
  Micah: { symbol: "scales", color: "#6a4ab5", colorLight: "#9878d4", categoryAr: "نبوة", order: 33 },
  Nahum: { symbol: "shield", color: "#4a5a6a", colorLight: "#788898", categoryAr: "نبوة", order: 34 },
  Habakkuk: { symbol: "watchtower", color: "#7a6a4a", colorLight: "#a89878", categoryAr: "نبوة", order: 35 },
  Zephaniah: { symbol: "fire", color: "#a85a3a", colorLight: "#d08868", categoryAr: "نبوة", order: 36 },
  Haggai: { symbol: "temple", color: "#b8893a", colorLight: "#d8b068", categoryAr: "نبوة", order: 37 },
  Zechariah: { symbol: "lampstand", color: "#4a6bb5", colorLight: "#7894d4", categoryAr: "نبوة", order: 38 },
  Malachi: { symbol: "sunRays", color: "#d4a93a", colorLight: "#e8c868", categoryAr: "نبوة", order: 39 },
