...
import t1 from "@/assets/church-1.jpg";
import t2 from "@/assets/church-2.jpg";
import t3 from "@/assets/church-3.jpg";
import t4 from "@/assets/playlist-1.jpg";
import t5 from "@/assets/playlist-3.jpg";

const items = [
  { rank: 1, img: t1, title: "حياة الصلاة الحقيقية", speaker: "البابا شنودة الثالث" },
  { rank: 2, img: t2, title: "كيف نسمع صوت الله", speaker: "أبونا داود لمعي" },
  { rank: 3, img: t3, title: "سر التوبة والاعتراف", speaker: "أبونا بيشوي كامل" },
  { rank: 4, img: t4, title: "رحلة الصوم الأربعيني", speaker: "أبونا تادرس يعقوب" },
  { rank: 5, img: t5, title: "الخدمة الروحية", speaker: "أبونا متى المسكين" },
];
