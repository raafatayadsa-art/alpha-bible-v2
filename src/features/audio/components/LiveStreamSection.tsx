...
import { audioStreamImages } from "../audio-assets";
import { SectionHeader } from "./SectionHeader";

const streams = [
  { img: audioStreamImages[0], name: "كنيسة مارمرقس بالعباسية", title: "قداس الأحد الإلهي", viewers: "2.4K" },
  { img: audioStreamImages[1], name: "كنيسة العذراء بشبرا", title: "اجتماع الترانيم الأسبوعي", viewers: "1.1K" },
  { img: audioStreamImages[2], name: "كنيسة الأنبا أنطونيوس", title: "تسبحة نصف الليل", viewers: "832" },
];
        ...
        {streams.map((s) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 p-3.5">
              ...
              <button
                type="button"
                className="inline-flex shrink-0 items-center gap-1 rounded-full bg-gradient-to-br from-[var(--gold-soft)] to-[var(--gold-deep)] px-3 py-1.5 text-[11px] font-bold text-white shadow-[0_6px_16px_-6px_rgba(180,130,60,0.55)]"
              >
