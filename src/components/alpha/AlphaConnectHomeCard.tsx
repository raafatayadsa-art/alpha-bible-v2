...
export function AlphaConnectHomeCard() {
  ...
  return (
    <article
      ...
      style={{
        borderColor: "rgba(231,201,122,0.38)",
        background: "#07040f",
        boxShadow:
          "0 16px 36px -14px rgba(0,0,0,0.62), 0 0 0 1px rgba(231,201,122,0.12), 0 0 24px rgba(110,181,240,0.1)",
      }}
    >
      <HeroLedgerStylesHost />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(105deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.2) 42%, rgba(0,0,0,0.72) 100%)",
        }}
      />
      <div
        aria-hidden
      ...
      <div className="relative z-10 flex h-full flex-col justify-between px-3 py-2.5 pointer-events-none">
        ...
        <div
          className="pointer-events-auto relative z-20 flex scale-[0.94] items-stretch gap-3 rounded-xl border px-1 py-0.5 origin-bottom"
          style={{
        ...
        >
          ...
          <div
            aria-hidden
            className="my-1 w-px shrink-0 bg-gradient-to-b from-transparent via-[#e7c97a]/35 to-transparent"
          />
          <HeroSpiritLedgerCell
            glyph="Ⲱ"
            label={rightLabel}
