  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[var(--alpha-content-max-width)] px-4 pt-[max(env(safe-area-inset-top),12px)]">
        <h1 className="text-[20px] font-extrabold text-[#f0d78c]">التأملات</h1>
        <p className="mt-2 text-[13px] font-medium leading-relaxed text-white/70">
          رحلات روحية وتأملات هادئة — المحتوى قيد الإعداد.
        </p>
      </div>
      <BottomDock />
    </div>
...
export const Route = createFileRoute("/meditations")({
  ...
  head: () => ({
    meta: [
      { title: "ألفا — التأملات" },
      { name: "description", content: "رحلات روحية وتأملات." },
    ],
  }),
